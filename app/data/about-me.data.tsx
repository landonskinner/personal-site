...
export const ABOUT_ME_CARDS = [
  {
    title: "Hi,\nI&aposm Landon Skinner.",
    description: "I&aposm a Front-End Engineer based in Denver, CO.",
  },
  {
    title: "Currently, I work at Gartner.",
    description:
      "My team built and supports our organization&aposs flagship forms-as-a-service application, which funnels +$100M in Pay-Per-Lead revenue annually.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Outside of work right now, I&aposm having fun experimenting with web animations. I&aposve been using Framer Motion to create some fun and engaging interactions.",
  },
  {
    title: "I do other things too.",
    description:
      "When I&aposm not at the computer, I enjoy hiking and camping, pretending to be a foodie, and being a dog dad.",
  },
  {
    title: (
      <>
        Check out what I&aposve been working on
