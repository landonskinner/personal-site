...
const StickyHeader = () => {
  ...
  return (
    <motion.svg
      ...
      className="stroke-primary text-primary sticky top-1 z-10 mx-auto py-14 px-12 mt-[20vh] sm:mt-[10vh] mb-8 max-w-[900px] rounded-5xl origin-top backdrop-blur-md"
      viewBox="0 0 800 225"
      style={{
        scale,
      }}
