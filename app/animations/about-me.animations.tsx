  ...
  return (
    <>
      <motion.ellipse
        ...
        rx="80"
        ry="80"
        className="fill-none stroke-background stroke-[6px]"
      />
      <motion.ellipse
        variants={{
          hover: {
  ...
  return (
    <>
      <motion.path
        ...
        transition={transition}
        className="fill-none stroke-background stroke-[20px] [stroke-dasharray:2]"
...
export const Background = ({ index }: { index: number }) => {
  return (
    <motion.svg
      ...
      className="absolute inset-0 z-0 p-2 m-auto max-w-full max-h-full"
      variants={{
        hover: {
          scale: 1.5,
        },
